...
EqIC:
	...
	LDR x0,=szInput1	// points to string1
	LDR x1,=szInput3	// points to string3
	BL  String_EqualsIgnoreCase	// string_equalsIgnoreCase(s1,s3)
...
EqIC2:
	...
	BL  String_EqualsIgnoreCase	// string_equalsIgnoreCase(s1,s2)
...
// substring_1
	...
	BL  String_substring_1		// substring(s3, 4, 14)
...
// substring_2
	...
	BL  String_substring_2		// strng_substring2(s3, 7)
...
// charAt
	...
	MOV x1, #4		// index = 4
	BL  String_charAt		// stirng_charAt(s2,4)
...
// String_startsWithIndex
	...
	BL  String_startWith_1	// string_startsWithIndex(s1, 11, "hat.")
...
startsWith2:
	...
	BL  String_startWith_2	// string_startsWith(s1, "Cat")
...
endsW:
	...
	BL  String_endWith	// string_endsWith(s1, "in the hat.")
